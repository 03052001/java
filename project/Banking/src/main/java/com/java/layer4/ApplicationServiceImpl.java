...
public class ApplicationServiceImpl implements ApplicationService {
	...
	public int findApplicationService(int applicationId) throws ApplicationNotFoundException 
	{
		 ...
		 boolean applicationFound=false;	
			...
			if(applicationFound==false)appDao.selectApplication(applicationId);
