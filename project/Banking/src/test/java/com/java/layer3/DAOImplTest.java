...
public class DAOImplTest {
	...
	Assertions.assertTrue(appDao!=null);
		...
		Application app=appDao.selectApplication(1);
	...
	app.setApplicantName("Shreyas");
	app.setFathername(" Rghava");
	app.setGender("M");
	app.setMobileNumber("9449225073");
	app.setEmailID("shreyas@gmail.com");
	app.setAdhaarNumber("584249072006");
	...
	Assertions.assertTrue(app!=null);
		...
		app.setApplicantName("Shriharsha ");
